    ...
    <div id="demo-1" class="page-content">
        <div class="dotts">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light">
                        <div class="logo">
                            <h1>
                                <a class="navbar-brand" href="<%=session.getAttribute("utype").toString() %>.jsp">
                                    <i class="fab fa-codepen"></i> Online Job Portal</a>
                            </h1>
                        </div>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ml-lg-auto text-center">
                                <li class="nav-item">
                                    <a class="nav-link" href="<%=session.getAttribute("utype").toString() %>.jsp">Home
                                ...
                                <%if(session.getAttribute("utype").toString().trim().equals("admin"))
                                	...
                                	%>
                                <li class="nav-item">
                                    <a class="nav-link" href="RegJobs.jsp">Register Jobs</a>
                                </li>
                                 <li class="nav-item">
                            	...
                            	%>
                            <li class="nav-item">
                                <a class="nav-link" href="RegEdu.jsp">Register Education Details</a>
                            </li>
